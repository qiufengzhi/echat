...
func (_c *IdentityCreate) SetProviderUID(v string) *IdentityCreate {
	_c.mutation.SetProviderUID(v)
	return _c
}

// SetMetadata sets the "metadata" field.
func (_c *IdentityCreate) SetMetadata(v map[string]interface{}) *IdentityCreate {
...
func (_c *IdentityCreate) check() error {
	...
	if _, ok := _c.mutation.ProviderUID(); !ok {
		return &ValidationError{Name: "provider_uid", err: errors.New(`ent: missing required field "Identity.provider_uid"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
